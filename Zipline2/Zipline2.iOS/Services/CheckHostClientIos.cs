...
{
    public class CheckHostClientIos : System.ServiceModel.ClientBase<ICheckHost>, ICheckHost
    {
        //Constructors
        public CheckHostClientIos()
        {
        }

        public CheckHostClientIos(string endpointConfigurationName) :
                base(endpointConfigurationName)
        {
        }

        public CheckHostClientIos(string endpointConfigurationName, string remoteAddress) :
                base(endpointConfigurationName, remoteAddress)
        {
        }

        public CheckHostClientIos(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) :
                base(endpointConfigurationName, remoteAddress)
        {
        }

        public CheckHostClientIos(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) :
