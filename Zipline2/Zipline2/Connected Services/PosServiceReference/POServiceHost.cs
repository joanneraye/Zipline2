...
public partial class PosServiceClient : System.ServiceModel.ClientBase<IPosService>, IPosService
{
    ...
    {
        string[] retVal = this.EndGetAvailablePaymentOptions(result);
        return new object[] {
                retVal};
    }
    ...
    {
        string[] retVal = this.EndGetCategoryNames(result);
        return new object[] {
                retVal};
    }
    ...
    {
        decimal[] retVal = this.EndGetNextGuestIDs(result);
        return new object[] {
                retVal};
    }
    ...
    {
        decimal[] ItemIDs = ((decimal[])(inValues[0]));
    ...
    public void GetThumbnailsAsync(decimal[] ItemIDs)
    {
        this.GetThumbnailsAsync(ItemIDs, null);
    }
    
    public void GetThumbnailsAsync(decimal[] ItemIDs, object userState)
    {
    ...
    {
        decimal[] OrderIDs = ((decimal[])(inValues[0]));
        decimal UserID = ((decimal)(inValues[1]));
    ...
    public void SendOrdersAsync(decimal[] OrderIDs, decimal UserID)
    {
        this.SendOrdersAsync(OrderIDs, UserID, null);
    }
    
    public void SendOrdersAsync(decimal[] OrderIDs, decimal UserID, object userState)
    {
    ...
    public void RemoveSentOrderAsync(decimal[] OrderIDs, decimal UserID)
    {
        this.RemoveSentOrderAsync(OrderIDs, UserID, null);
    }
    
    public void RemoveSentOrderAsync(decimal[] OrderIDs, decimal UserID, object userState)
    {
    ...
    {
        decimal[] GuestIDs = ((decimal[])(inValues[0]));
    ...
    public void MoveGuestsAsync(decimal[] GuestIDs, decimal NewTableID)
    {
        this.MoveGuestsAsync(GuestIDs, NewTableID, null);
    }
    
    public void MoveGuestsAsync(decimal[] GuestIDs, decimal NewTableID, object userState)
    {
    ...
    private System.IAsyncResult OnBeginCombineOrders(object[] inValues, System.AsyncCallback callback, object asyncState)
    {
        ...
        decimal[] GuestsToMoveIDs = ((decimal[])(inValues[1]));
    ...
    public void CombineOrdersAsync(decimal DestinationGuestID, decimal[] GuestsToMoveIDs, bool RemoveAfterCombine)
    {
        this.CombineOrdersAsync(DestinationGuestID, GuestsToMoveIDs, RemoveAfterCombine, null);
    }
    
    public void CombineOrdersAsync(decimal DestinationGuestID, decimal[] GuestsToMoveIDs, bool RemoveAfterCombine, object userState)
    {
    ...
    {
        decimal[] TableIDList = ((decimal[])(inValues[0]));
    ...
    {
        decimal[] retVal = this.EndListUnsentOrders(result);
        return new object[] {
                retVal};
    }
    ...
    public void ListUnsentOrdersAsync(decimal[] TableIDList)
    {
        this.ListUnsentOrdersAsync(TableIDList, null);
    }
    
    public void ListUnsentOrdersAsync(decimal[] TableIDList, object userState)
    {
    ...
    public void PrintMoveNoticeAsync(decimal[] orderIDs, decimal fromTableID, decimal toTableID)
    {
        this.PrintMoveNoticeAsync(orderIDs, fromTableID, toTableID, null);
    }
    
    public void PrintMoveNoticeAsync(decimal[] orderIDs, decimal fromTableID, decimal toTableID, object userState)
    {
    ...
    public void AddOrdersToPlateAsync(decimal[] orderIds, decimal plateId)
    {
        this.AddOrdersToPlateAsync(orderIds, plateId, null);
    }
    
    public void AddOrdersToPlateAsync(decimal[] orderIds, decimal plateId, object userState)
    {
    ...
    public void RemoveMultipleFromPlateAsync(decimal[] orderIDs)
    {
        this.RemoveMultipleFromPlateAsync(orderIDs, null);
    }
    
    public void RemoveMultipleFromPlateAsync(decimal[] orderIDs, object userState)
    {
